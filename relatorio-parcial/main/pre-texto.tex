...
\trabalho       {Relatório Parcial de Projeto de Iniciação Científica}
\titulo         {Modelo de Relatório Parcial para Projetos de Iniciação Científica}
\cidade         {São Paulo}
...
\preambulo      {Relatório parcial do projeto de Iniciação Científica voltado para o Curso Superior de Ciência da Computação da \imprimiruniversidade.}
